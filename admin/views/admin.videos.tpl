...
<div class="content docs-list">
	...
	<ul class="video-host">
		<li><a target="_blank" href="https://www.youtube.com/upload"><img src="/admin/files/img/youtube.png" alt="YouTube" /></a></li>
		<li><a target="_blank" href="https://vimeo.com/upload"><img src="/admin/files/img/vimeo.png" alt="Vimeo" /></a></li>
	</ul>
</div>
