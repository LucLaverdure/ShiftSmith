...
<div class="wrapper">
	...
	<a href="/user">Administration</a> &gt; <a href="/core/admin/forge">Forge</a> &gt; Page
	...
	<form method="post" action="" enctype="multipart/form-data">
		...
		<label>
			...
			<input id="forge-private" class="chktype forge-private" type="checkbox" name="trigger.private" value="Y" data-val="[page.trigger.private]" /> Make page private
		</label>
