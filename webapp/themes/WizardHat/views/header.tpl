...
<title>ShiftSmith - The Blacksmith of Websites</title>

<link href="https://fonts.googleapis.com/css?family=Raleway" rel="stylesheet">
<link href="https://fonts.googleapis.com/css?family=Questrial" rel="stylesheet">


<link rel="stylesheet" type="text/css" href="/theme/files/lib/prism/prism.css" />
<link rel="stylesheet" type="text/css" href="/theme/files/lib/hover/hover-min.css" />
...
<div class="wrapper cf">
	<a href="/"><img id="main-logo" src="/theme/files/img/anvil-black.png" /></a>
	...
	<ul class="nav">
		...
		<li><a href="/#select-url" class="button">Install</a></li>
	</ul>
</div>